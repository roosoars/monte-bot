...
O sistema usa configurações otimizadas para **streaming instantâneo** com latência mínima de 100-200ms:
...
| `STREAM_KEYFRAME_INTERVAL` | `5` | Keyframe a cada 5 frames (~166ms @ 30fps) |
| `HLS_SEGMENT_SECONDS` | `0.1` | Duração do segmento HLS (100ms - instantâneo) |
